...
class ModelAccountAddress extends Model {
	...
	public function editAddress($address_id, $data) {
		//frd
		$this->db->query("UPDATE " . DB_PREFIX . "address SET district_id ='" . (int)$this->db->escape($data['district_id']) ."', firstname = '" .

	...
	public function getAddress($address_id) {
		...
		if ($address_query->num_rows) {
			...
			$address_data = array(
				...
				'subdistrict_id'     => $address_query->row['subdistrict_id'],//frd
